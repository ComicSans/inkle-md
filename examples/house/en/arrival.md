...
The knocker is a brass face with an expression one could generously call
expectant.

* Knock
* Shine the lantern through the side window first

# The Side Window {#window}

In the beam: a hall, a staircase, and on the third step sits someone who does
not move as long as you watch. You watch for a while. It stays that way.

Only when the beam begins to tremble do you notice that it is your hand doing
the trembling. Your FEAR rises.

* Knock anyway
* Put out the lantern and think for a moment
...
The door opens before your hand reaches the knocker. Behind it stands a
butler who looks as if he had been waiting for precisely you, and for longer
than would be polite.

{knows("AUF-DER-TREPPE"): Behind him lies the staircase you saw through the side window. The third step, where someone was sitting a moment ago, is empty.}
...
You keep asking: about an inn, a garage, the nearest town with lights. He
waits until you have finished, and then waits a moment longer, so that you
notice him waiting.
...
"Nothing," he says, with a stress on the Nothing that will stay with you for
a while.
...
A table for twelve, laid for two. At the far end sits the master of the
house, smiling, pouring for you without asking. The wine is darker than wine
needs to be.

He asks questions about your journey, your family, whether anyone is
expecting you. On the last question he listens with particular care.
...
He nods, slowly and with satisfaction, and refills your glass.

His smile stays where it is, but something now sits differently in it.

Then he raises his glass and waits. It is the kind of waiting that makes you
notice he has not yet drunk a drop himself.

Twenty years of customers: you praise the colour, the nose, the finish, and
set the glass down and pick it up so many times that in the end no one knows
how full it ever was. The oldest trick in the case.

The plant takes it like one that has swallowed worse. The master notices
nothing. The butler saw nothing. You are almost sure of that. Almost.

One leaf of the aspidistra turns brown before you have left the table. The
master sees it, looks at you, and raises his glass a second time, this time
without smiling.

The butler clears your glass away with the face of a man whose evening has
just become more complicated.

Afterwards the butler shows you to your room. The candle he gives you is
